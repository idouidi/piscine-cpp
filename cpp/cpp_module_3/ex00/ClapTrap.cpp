...
/*   Updated: 2022/02/01 17:56:30 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std:: cout << "(Constructor with string argument)\n- " << name << " is coming...." << std::endl;
}
...
ClapTrap& ClapTrap::operator=(const ClapTrap& c)
{
	...
	std:: cout << "(Assigantion overload Constructor)\n- " << name << " is coming...." << std::endl;
	return (*this);
}

ClapTrap::~ClapTrap()
{
	std:: cout << "(Destructor) " << name << " is leaving...." << std::endl;
}
